...
export class avalaunchstaking extends ethereum.SmartContract {
  static bind(address: Address): avalaunchstaking {
    return new avalaunchstaking("avalaunchstaking", address);
  }
